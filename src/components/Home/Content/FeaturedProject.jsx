...
export default function ProjectShowcase() {
  ...
  return (
    <div className="max-w-4xl h-full relative z-10">
      <div
        className={`mb-4 transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
          }`}
      >
        <h1
      ...
      <div className="w-full flex flex-col justify-between space-y-4 flex-1 ">
        {projects
          ...
          .map((project, index) => (
            <div
              key={index}
              className={`w-full rounded-xl overflow-hidden transition-all  duration-300 ${isVisible
            ...
            >
              ...
              >
                ...
                <div
                  className={`text-gray-400 transition-transform duration-300 ${hoveredProject === index ? "scale-125" : "scale-100"
                    }`}
                >
                  {activeTab === index ? (
                    <ChevronUp size={20} />
              ...
              <div
                className={`transition-all duration-300 ease-in-out overflow-hidden ${activeTab === index
